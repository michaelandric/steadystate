...
library(bct)
srcdst <- paste(Sys.getenv("state"),"/links_files/modularity/",subj,".",cond,".",thresh,"median_linksthresh_proportion.out.srcdst", sep="") 
tree <- paste(Sys.getenv("state"),"/links_files/modularity/",subj,".",cond,".",thresh,"median_linksthresh_proportion.out.tree", sep="")
modularity_score = blondel_community(srcdst, tree)
print(modularity_score)

modout <- paste(Sys.getenv("state"),"/links_files/modularity/mod_score.",subj,".",cond,".",thresh,"median_linksthresh_proportion.txt",sep="")
