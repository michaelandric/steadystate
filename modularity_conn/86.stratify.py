...
if __name__ == "__main__":
    ...
    for h in ['lh', 'rh']:
        inname = "preserved_group_median5p__20vxFltr_warped_median_"+h+".pn2.0.tlrc.1D"
        outname = "stratified_preserved_group_median5p__20vxFltr_warped_median_"+h+".pn2.0.tlrc.1D"
