...
{
    library(bct)
    srcdst <- paste(Sys.getenv("state"),"/",ss,"/corrTRIM_BLUR/cleanTS.Cond",i,".",ss,".noijk_dump.bin.corr.thresh.srcdst",sep="")
    tree <- paste(Sys.getenv("state"),"/",ss,"/corrTRIM_BLUR/cleanTS.Cond",i,".",ss,".noijk_dump.bin.corr.thresh.tree",sep="")
...
print(mod)
modout <- paste(Sys.getenv("state"),"/",subj,"/corrTRIM_BLUR/modularityscore.",subj,".Cond",cond,".txt",sep="")
