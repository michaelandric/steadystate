...
print(apply(dat_matA,2,mean))
print(apply(dat_matB,2,mean))
print(apply(dat_matG,2,mean))

print(wilcox.test(dat_matB[,1], dat_matB[,2], paired = TRUE))
print(wilcox.test(dat_matB[,1], dat_matB[,3], paired = TRUE))
print(wilcox.test(dat_matB[,1], dat_matB[,4], paired = TRUE))
print(wilcox.test(dat_matB[,2], dat_matB[,3], paired = TRUE))
print(wilcox.test(dat_matB[,2], dat_matB[,4], paired = TRUE))
print(wilcox.test(dat_matB[,3], dat_matB[,4], paired = TRUE))

print(wilcox.test(dat_matG[,1], dat_matG[,2], paired = TRUE))
print(wilcox.test(dat_matG[,1], dat_matG[,3], paired = TRUE))
print(wilcox.test(dat_matG[,1], dat_matG[,4], paired = TRUE))
print(wilcox.test(dat_matG[,2], dat_matG[,3], paired = TRUE))
print(wilcox.test(dat_matG[,2], dat_matG[,4], paired = TRUE))
print(wilcox.test(dat_matG[,3], dat_matG[,4], paired = TRUE))
