...
def volsurf_tal_pres_avg_cmd(H, pn):
    ...
    PARENT = "preserved_group_median5p_warped_median+tlrc"   # already copied to suma_tlrc dir from groupstats dir
    SV = "TT_N27+tlrc"
    print call("3dVol2Surf -spec ./N27_"+H+"_tlrc.spec -surf_A ./"+H+".smoothwm.tlrc.ply -surf_B ./"+H+".pial.tlrc.ply \
                ...
                -outcols_NSD_format -oob_index -1 -oob_value 0.0 -out_1D preserved_group_median5p_warped_median_"+H+".pn"+pn+".tlrc.1D", shell=True)
